...
var en = {
  ...
  'skills': {
    ...
    paragraphs: ["Throughout the last two year I've read articles, watched tutorial and did courses to sharp my knowledge. Most of my studies are based on Udemy courses.", "At frontend I have experience with React and Angular. I'm careful to provide a responsive design along with optimized bundle, lazy loading, tree shaking, protected routes and user authentication", "Meanwhile, my backend focus is primary NodeJS based, with experience in MongoDB & GraphQL and some knowledge at SQL database. For user authentication, encrypting properly user password and managing the token creation without providing sensible data back to frontend.", "I have to thank a lot to great instructors that delivered high quality content for professional development: Andrew Mead, Stephen Grider, Maximilian Schwarzmuller, Brad Traversy, Leonardo Leitao, Andrei Neagoie."],
...
//# sourceMappingURL=index.js.c2c6c93d7c7efe7f0447.hot-update.js.map